...
class Registro(models.Model):
    ...
    data_nascimento = models.DateField(('Data de Nascimento'), default=datetime.now, blank=True)
    ...
    data_conversao = models.DateField(('Data de Conversão'), null=True)
    data_batismo = models.DateField(('Data de Batismo'), null=True)
    ...
    foto = models.FileField(upload_to='imagens/foto', default=None, null=True)
